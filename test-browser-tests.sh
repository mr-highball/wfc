...
if [[ "$standalone" == true ]]; then
 ...
 for source in test/*_test.lpr; do
  ...
  case "$name" in wfc_package_check_process_test|wfc_asset_check_process_test|wfc_artifact_cli_process_test|wfc_ensemble_http_process_test|wfc_mapped_world_process_test|wfc_pipeline_mapped_process_test) continue ;; esac
