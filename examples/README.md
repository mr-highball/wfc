...
| --- | --- | --- | --- |
| Pipeline Workspace | [passes/08_PipelineWorkspace](passes/08_PipelineWorkspace/README.md), [native guide](passes/08_PipelineWorkspace/NATIVE.md) | Native FPC/SVG, pas2js/browser | Generic canonical model/run authoring, editable pass geometry, public locks/domains, explicit repair permissions, complete journals and actual replay; landscape and learned-sequence priming share one controller. Included FPC build/hosting tools; no external runtime packages. |
...
| Training Studio | [learning/05_TrainingStudio](learning/05_TrainingStudio/README.md) | Native FPC, pas2js/browser | Editable corpora, explicit open/circular Unicode-scalar text import, seeded runs, public locks, failure inspection, and artifact exports share one invalidation-aware Pascal workspace; seven native presets include a checked circular-text workflow. |
