...
for source in test/*_test.lpr; do
  ...
  case "$name" in wfc_package_check_process_test|wfc_artifact_cli_process_test|wfc_ensemble_http_process_test|wfc_pipeline_mapped_process_test) continue ;; esac
...
echo 'Pascal browser conformance, capture fixture, and eleven actual demo entries staged under build/browser/tests/www.'
